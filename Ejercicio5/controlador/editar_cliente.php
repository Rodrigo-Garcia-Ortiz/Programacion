<?php
require_once '../modelo/funciones.php'; // Importar las funciones
...
<body>
    ...
    <form action="../controlador/actualizar_cliente.php" method="POST">
        ...
        <input type="tel" name="telefono" id="telefono" value="<?= $clienteSeleccionado[3] ?>" required>
        <br>
