...
<body>
    ...
    <form action="editar_evento.php?id=<?= htmlspecialchars($evento['id_evento']) ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nombre" name="nombre" class="form-control" value="<?= htmlspecialchars($evento['nombre_evento']) ?>" required>
        </div>

        <div class="mb-3">
            <label for="fecha">Fecha</label>
            <input type="date" id="fecha" name="fecha" class="form-control" value="<?= htmlspecialchars($evento['fecha']) ?>" required>
        </div>

        <div class="mb-3">
            <label for="lugar">Lugar</label>
            <input type="text" id="lugar" name="lugar" class="form-control" value="<?= htmlspecialchars($evento['lugar']) ?>" required>
        </div>
