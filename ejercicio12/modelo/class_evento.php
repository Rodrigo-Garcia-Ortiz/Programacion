...
class Evento {
    ...
    public function obtenerEventos() { //Recoge los datos de todos los eventos de la base de datos
    ...
    public function obtenerEventoPorId($id_evento) { //Recoge los datos del evento del id indicado
    ...
    public function eliminarEvento($id_evento) { //Elimina los datos del evento indicado
